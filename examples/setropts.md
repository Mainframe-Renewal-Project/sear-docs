...
> Remember that these settings impact the whole system, make sure any planned changes are sound before using SEAR to make any kind of changes. It is also good to keep in mind that information extracted about system settings is highly sensitive and should be stored securely.
